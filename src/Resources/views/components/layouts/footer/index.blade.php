    ...
    <div class="flex justify-between gap-x-6 gap-y-8 p-[60px] max-1060:flex-col-reverse max-md:gap-5 max-md:p-8 max-sm:px-4 max-sm:py-5">
        ...
        <div>
            <div class="footer-contact">
                <h1 class="text-lg font-bold mb-4">Get in Touch</h1>
                <ul class="contact-details space-y-2">
                    <li class="flex items-center mb-4">
                        <i class="fas fa-map-marker-alt mr-2"></i>
                        <a 
                            href="https://www.google.com/maps/search/1234 Your Street, Your City, Your Country" 
                            target="_blank" 
                    ...
                    <li class="flex items-center mb-4">
                        ...
                        <a href="mailto:contact@yourdomain.com" class="text-blue-600 hover:underline">
                            contact@yourdomain.com
                        </a>
                    </li>
                    <li class="flex items-center mb-4">
                        <i class="fas fa-phone mr-2"></i> 
                        <a href="tel:+123456789" class="text-blue-600 hover:underline">
                            +1 (234) 567-89
                        </a>
                    </li>
                </ul>
            ...
            <div class="flex gap-3 mt-4">
                @foreach(['enable_facebook', 'enable_google', 'enable_linkedin-openid', 'enable_github'] as $social)
