            ...
            <template v-else>
                <div class="row grid grid-cols-[2fr_1fr_1fr] grid-rows-1 items-center border-b px-4 py-2.5 dark:border-gray-800">
                    <div
                        ...
                        v-for="(columnGroup, index) in [['name', 'sku', 'attribute_family'], 
                        ['base_image'],
                        {{-- Removed the heading from the product--}}
            ...
            <template v-else>
                ...
                >
                    ...
                    <div class="flex items-center justify-between gap-x-4">
                        <!-- Remove status, categry from product -->
                        {{-- <div class="flex flex-col gap-1.5">
