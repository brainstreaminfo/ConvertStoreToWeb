...
use Webkul\Installer\Database\Seeders\Shop\ThemeCustomizationTableSeeder as BaseThemeCustomizationTableSeeder;

class ThemeCustomizationTableSeeder extends BaseThemeCustomizationTableSeeder
{
    /**
                        ...
                        'options'                => json_encode([
                            'column_1' => [
                                [
                                    ...
                                    'url'        => $appUrl.'/page/services',
                                    'title'      => trans('convertstoretoweb::app.convertstoretoweb.footerpages.services', [], $locale),
                                    'sort_order' => 3,
                                ], [
                            ...
                            'column_2' => [
                                [
                                    ...
                                    'url'        => $appUrl.'/page/team',
                                    'title'      => trans('convertstoretoweb::app.convertstoretoweb.footerpages.team', [], $locale),
                                    'sort_order' => 3,
                                ], [
                                    'url'        => $appUrl.'/page/our-story',
                                    'title'      => trans('convertstoretoweb::app.convertstoretoweb.footerpages.our-story', [], $locale),
                                    'sort_order' => 4,
                                ], [
                                    'url'        => $appUrl.'/page/award',
                                    'title'      => trans('convertstoretoweb::app.convertstoretoweb.footerpages.award', [], $locale),
                                    'sort_order' => 5,
                                ],
                            ],
                        ]),
